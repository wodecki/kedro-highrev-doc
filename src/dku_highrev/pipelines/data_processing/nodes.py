...
def prepare_customers(orders_by_customer, customers):
    ...
    customers_prepared = pd.merge(customers, orders_by_customer, left_on='customer_id', right_on='customerID', how='inner')
    ...
    customers_prepared = customers_prepared.drop(['birthdate', 'order_date', 'order_id', 'ip_address', 'user_agent'], axis=1)
